...
\setmainfont[BoldFont={HannotateSC-W7}]{HannotateSC-W5}  % 细文，手札体
\setCJKmainfont[BoldFont={HannotateSC-W7}]{HannotateSC-W5} % 中文，手札体
...
\title{基于 ElegantNote 修改的 \LaTeX{} 笔记模板}
\author{模板更新作者}
\institute{Jeff}
\version{3.00}
\date{\zhdate{2025/7/28}}
...
\newpage 													% 新建页面用于显示摘要
\section{更新记录}
2025-07-28 ------ 初始化模板文件，修改默认字体，添加目录页并设置页码
...
\textbf{\textcolor{red}{原始模板 ElegantNote 自 2023 年 1 月 1 日开始，不再维护，为了继续使用此模板，并加入个人需要的特性和配置，所以 Fork 了原始模板的代码文件，并开始在进行维护。}}
